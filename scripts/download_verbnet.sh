...
echo "Unzip ..."
tar xvzf ${save_dir}/verbnet-3.2.tar.gz
echo "Saved to ${save_dir}/verbnet3.2"

# VerbNet 3.3
wget -P ${save_dir} http://verbs.colorado.edu/verb-index/vn/verbnet-3.3.tar.gz
echo "Unzip ..."
tar xvzf ${save_dir}/verbnet-3.3.tar.gz
echo "Saved to ${save_dir}/verbnet3.3"

# VerbNet 3.4
git clone https://github.com/cu-clear/verbnet.git /tmp
cp -R /tmp/verbnet/verbnet3.4/ ${save_dir}
